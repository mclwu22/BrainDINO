...
class _NoOpWriter:
    """Fallback writer when tensorboard initialization is not available."""
...
class Recorder:
    def __init__(self, config):
        ...
        self.save_dir = config.save_root
        ...
        try:
            ...
            self.logger.warning(
                "SummaryWriter init failed (%s). Falling back to no-op writer.", str(e)
            )
