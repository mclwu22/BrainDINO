...
if __name__ == "__main__":
    dataset = "Dataset006_ACDC"
    trainer = "dinov3_base_primus_multiscale_Trainer_3000_epoch__nnUNetPlans__2d_640"
    preds_dir = f"/scr2/yz_wu/data/Foundation/nnProcessed/nnUNet_results/{dataset}/{trainer}/fold_0/validation"
    csv_filename = preds_dir + "/segmentation_metrics.csv"

    labels_dir = f"/scr2/yz_wu/data/Foundation/nnProcessed/nnUNet_raw/{dataset}/labelsTr"
    # Load dataset.json which contains the labels mapping (including background)
    dataset_json_path = f"/scr2/yz_wu/data/Foundation/nnProcessed/nnUNet_raw/{dataset}/dataset.json"  # Change this path if needed
