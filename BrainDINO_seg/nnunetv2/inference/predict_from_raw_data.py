...
class nnUNetPredictor(object):
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        # Add patch_size to arch_init_kwargs if not already present (needed for custom trainers)
        arch_init_kwargs = configuration_manager.network_arch_init_kwargs.copy()
        if 'patch_size' not in arch_init_kwargs and hasattr(configuration_manager, 'patch_size'):
            arch_init_kwargs['patch_size'] = configuration_manager.patch_size
