...
TASK_SPECS = {
    ...
    "knn_adni_oasis": TaskSpec(
        ...
        notes="Frozen-feature kNN probing: encoder features are L2-normalized, the train split is the memory bank, and a query is labelled by cosine-similarity majority vote over its k nearest neighbours. Not included as a runnable entry here.",
    ),
